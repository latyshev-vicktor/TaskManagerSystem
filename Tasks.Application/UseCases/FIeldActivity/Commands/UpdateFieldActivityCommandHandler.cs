...
{
    public class UpdateFieldActivityCommandHandler(TaskDbContext dbContext) : IRequestHandler<UpdateFieldActivityCommand, IExecutionResult<Guid>>
    {
        public async Task<IExecutionResult<Guid>> Handle(UpdateFieldActivityCommand request, CancellationToken cancellationToken)
        {
