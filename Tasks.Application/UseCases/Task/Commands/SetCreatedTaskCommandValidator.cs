...
{
    public class SetCreatedTaskCommandValidator(TaskDbContext dbContext) : RequestValidator<SetCreatedTaskCommand>
    {
        public async override Task<IExecutionResult> RequestValidateAsync(SetCreatedTaskCommand request, CancellationToken cancellationToken)
        {
