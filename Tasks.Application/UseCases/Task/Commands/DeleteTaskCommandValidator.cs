...
{
    public class DeleteTaskCommandValidator(TaskDbContext dbContext) : RequestValidator<DeleteTaskCommand>
    {
        public async override Task<IExecutionResult> RequestValidateAsync(DeleteTaskCommand request, CancellationToken cancellationToken)
        {
