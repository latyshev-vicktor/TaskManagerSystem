...
{
    public class SetCreatedTaskCommandHandler(TaskDbContext dbContext, IPublishEndpoint publishEndpoint) : IRequestHandler<SetCreatedTaskCommand, IExecutionResult>
    {
